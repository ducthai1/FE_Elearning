...
<head>
   ...
   <title>Bài giảng đã thích</title>
...
<section class="liked-videos">
   ...
   <h1 class="heading">Bài giảng đã thích</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Xem bài giảng</a>
         <input type="submit" value="Xóa" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
         }else{
            echo '<p class="emtpy">Không thấy nội dung bài giảng!</p>';         
         }
      }
   }else{
      echo '<p class="empty">Chưa có bài giảng nào được thích!</p>';
   }
   ?>
