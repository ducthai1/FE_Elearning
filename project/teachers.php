...
<section class="teachers">
   ...
   <h1 class="heading">Giảng viên có kinh nghiệm</h1>
   ...
   <div class="box-container">
      ...
      <div class="box offer">
         ...
         <p>Hãy nộp hồ sơ và đăng ký ngay bây giờ nếu bạn muốn trở thành giảng viên cho trang web của chúng tôi!</p>
      ...
      <div class="box">
         ...
         <p>Tổng bài giảng : <span><?= $total_contents ?></span></p>
      ...
      <?php
            ...
            echo '<p class="empty">Không tìm thấy giảng viên!</p>';
         }
      ?>
