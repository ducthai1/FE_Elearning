   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <p>Chuyên ngành của bạn <span>*</span></p>
            <select name="profession" class="box" required>
               <option value="" disabled selected>-- Chọn chuyên ngành của bạn</option>
               <option value="subteacher">Trợ giảng</option>
         ...
         <div class="col">
            ...
            <input type="password" name="cpass" placeholder="Nhập lại mật khẩu của bạn" maxlength="20" required class="box">
