...
<section class="video-form">
   ...
   <h1 class="heading">Đăng tải bài giảng</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Tình trạng video <span>*</span></p>
      ...
      <textarea name="description" class="box" required placeholder="Nhập mô tả" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Danh sách video <span>*</span></p>
      <select name="playlist" class="box" required>
         ...
         <?php
            ...
            echo '<option value="" disabled>Chưa có Khóa học nào được tạo!</option>';
         }
         ?>
      </select>
      <p>Chọn ảnh thu nhỏ <span>*</span></p>
      <input type="file" name="thumb" accept="image/*" required class="box">
      <p>Chọn video <span>*</span></p>
      <input type="file" name="video" accept="video/*" required class="box">
      <input type="submit" value="Tải video" name="submit" class="btn">
   </form>
